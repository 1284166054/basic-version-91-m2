...
exports.bind_start = exports.Z_bind = exports.P_bind = exports.bind = exports.changeMoney_1 = exports.changeMoney = exports.changeGold_1 = exports.changeGold = exports.mbind = exports.getback = exports.storage = exports.Main = void 0;
...
exports.Main = Main;
function storage(Npc, Player, Args) {
    const S = `
需要保管什么东西?\\\\
<返回/@Main>
`;
...
function getback(Npc, Player, Args) {
    const S = `
请看目录决定找什么东西.\\\\\\
<返回/@Main>
`;
...
function mbind(Npc, Player, Args) {
    const S = `
你知道我是什么人吗？ \\
我做的是这样的事情... \\
你要试一下吗？有什么要拜托的就说吧 \\\\
...
exports.mbind = mbind;
function changeGold(Npc, Player, Args) {
    const S = `
你说你要用金币换成金条? \\
好的，我帮你换 \\
但是要支付手续费 \\
...
function changeGold_1(Npc, Player, Args) {
    const S = `
金币已经换好金条了. \\
还换吗？ \\\\
<交换/@changeGold> \\
...
exports.changeGold_1 = changeGold_1;
function changeMoney(Npc, Player, Args) {
    const S = `
你要把金条换成金币? \\
好的，我给你换 \\
不过需要支付手续费\\
...
function changeMoney_1(Npc, Player, Args) {
    const S = `
我也很想给你换， \\
但是你钱太多了，我没办法给你换. \\\\
 `;
...
exports.changeMoney_1 = changeMoney_1;
function bind(Npc, Player, Args) {
    const S = `
目前我能捆的只有卷书和药水 \\
你要捆吗？ \\
要捆东西需要100金币. \\\\
...
exports.bind = bind;
function P_bind(Npc, Player, Args) {
    const S = `
...
function Z_bind(Npc, Player, Args) {
    const S = `
...
exports.Z_bind = Z_bind;
function bind_start(Npc, Player, Args) {
    let item = Args.Str[0];
...
exports.bind_start = bind_start;
//# sourceMappingURL=%E4%BB%93%E5%BA%93.js.map