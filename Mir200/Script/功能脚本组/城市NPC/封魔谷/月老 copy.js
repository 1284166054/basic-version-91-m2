...
exports.fUnMarry = exports.RevUnMarry = exports.RequestUnMarry = exports.unmarry = exports.CheckPoseCreateCanMarry = exports.ResposeMarry = exports.ResposeMarryFail = exports.RequestMarry = exports.agree = exports.marry = exports.Main = void 0;
...
exports.agree = agree;
function RequestMarry(Npc, Player, Args) {
    const S = `
对方向你求婚，你是否答应嫁给他？ \\ \\
<我愿意/@ResposeMarry> \\
...
exports.RequestMarry = RequestMarry;
...
function CheckPoseCreateCanMarry(Npc, Player) {
...
exports.CheckPoseCreateCanMarry = CheckPoseCreateCanMarry;
function unmarry(Npc, Player) {
    const S = `
...
function RequestUnMarry(Npc, Player) {
    if (!Player.Married) {
        Npc.Say(Player, `你都没结婚离什么婚？？\\\\<返回/@Main>`);
        return;
    }
...
function RevUnMarry(Npc, Player) {
    if (!Player.Married) {
        Npc.Say(Player, `你都没结婚离什么婚？？\\\\<返回/@Main>`);
        return;
    }
...
//# sourceMappingURL=%E6%9C%88%E8%80%81%20copy.js.map